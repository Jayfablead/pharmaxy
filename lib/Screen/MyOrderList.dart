                      ...
                      sel == 0
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          maxLines:
                                                                              1,
                                                                          myorderlistmodal?.data?[index].orderNumber == '' || myorderlistmodal?.data?[index].orderNumber == null
                                                                              ? 'N/A'
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          myorderlistmodal?.data?[index].totalAmount == "" || myorderlistmodal?.data?[index].totalAmount == null
                                                                              ? "N/A"
                                                                      ...
                                                                      GestureDetector(
                                                                        onTap:
                                                                          ...
                                                                          Navigator.of(context)
                                                                              .push(MaterialPageRoute(builder: (context) => OrderSummary(iteamid: myorderlistmodal?.data?[index].orderId)));
                                                                        },
                                                                        child: Container(
                                                                            alignment: Alignment.center,
                          ...
                          : sel == 1
                              ? paidorderModel?.data?.length == 0 ||
                                      paidorderModel?.data?.length == null ||
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                maxLines: 1,
                                                                                "Order Number:- ",
                                                                                style: TextStyle(overflow: TextOverflow.ellipsis, color: Colors.black, fontSize: 11.sp, fontWeight: FontWeight.normal, fontFamily: "task"),
                                                                              ),
                                                                              Text(
                                                                                maxLines: 1,
                                                                                paidorderModel?.data?[index].orderNumber == '' || paidorderModel?.data?[index].orderNumber == null ? 'N/A' : paidorderModel?.data?[index].orderNumber ?? '',
                                                                                style: TextStyle(overflow: TextOverflow.ellipsis, color: Colors.black, fontSize: 10.sp, fontWeight: FontWeight.w600, fontFamily: "task"),
                                                                              ),
                                                                            ],
                                                                          ),
                                                                        ),
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              paidorderModel?.data?[index].totalAmount == "" || paidorderModel?.data?[index].totalAmount == null ? "N/A" : '₹' + (paidorderModel?.data?[index].totalAmount).toString(),
                                                                              style: TextStyle(
                                                                                fontSize: 12.sp,
                                                                                fontFamily: 'task',
                                                                                fontWeight: FontWeight.bold,
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          ...
                                                                          GestureDetector(
                                                                            onTap:
                                                                                () {
                                                                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => OrderSummary(iteamid: paidorderModel?.data?[index].orderId)));
                                                                            },
                                                                            child: Container(
                                                                                alignment: Alignment.center,
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                        CachedNetworkImage(
                                                                      imageUrl:
                                                                          shippedorderModel?.data?[index].firstImage ??
                                                                              '',
                                                                      height:
                                                                          25.w,
                                                                      width:
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Row(
                                                                                children: [
                                                                                  ...
                                                                                  Text(
                                                                                    maxLines: 1,
                                                                                    shippedorderModel?.data?[index].orderNumber == '' || shippedorderModel?.data?[index].orderNumber == null ? 'N/A' : "# " + (shippedorderModel?.data?[index].orderNumber).toString(),
                                                                                    style: TextStyle(overflow: TextOverflow.ellipsis, color: Colors.black, fontSize: 10.sp, fontWeight: FontWeight.w600, fontFamily: "task"),
                                                                                  ),
                                                                                ],
                                                                              ),
                                                                          ...
                                                                          Row(
                                                                            children: [
                                                                              Text(
                                                                                "shipped",
                                                                                style: TextStyle(fontSize: 11.sp, fontFamily: 'task', fontWeight: FontWeight.bold, letterSpacing: 1, color: AppColors.primary),
                                                                              ),
                                                                              SizedBox(
                                                                                width: 4.w,
                                                                              ),
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            CachedNetworkImage(
                                                                          imageUrl:
                                                                              placedorderModel?.data?[index].firstImage ?? '',
                                                                          height:
                                                                              25.w,
                                                                          width:
                                                                              25.w,
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                child: SizedBox(
                                                                                  ...
                                                                                  child: Row(
                                                                                    children: [
                                                                                      ...
                                                                                      Text(
                                                                                        maxLines: 1,
                                                                                        placedorderModel?.data?[index].orderNumber == '' || placedorderModel?.data?[index].orderNumber == null ? 'N/A' : placedorderModel?.data?[index].orderNumber ?? '',
                                                                                        style: TextStyle(overflow: TextOverflow.ellipsis, color: Colors.black, fontSize: 10.sp, fontWeight: FontWeight.w600, fontFamily: "task"),
                                                                                      ),
                                                                                    ],
                                                                                  ),
                                                                              ...
                                                                              Row(
                                                                                children: [
                                                                                  Text(
                                                                                    "placed",
                                                                                    style: TextStyle(fontSize: 11.sp, fontFamily: 'task', fontWeight: FontWeight.bold, letterSpacing: 1, color: Colors.green),
                                                                                  ),
                                                                                  SizedBox(
                                                                                    width: 4.w,
                                                                                  ),
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                CachedNetworkImage(
                                                                              imageUrl: pendingordermodal?.data?[index].firstImage ?? '',
                                                                              height: 25.w,
                                                                              width: 25.w,
                                                                                    ...
                                                                                    child: SizedBox(
                                                                                      ...
                                                                                      child: Row(
                                                                                        children: [
                                                                                          ...
                                                                                          Text(
                                                                                            maxLines: 1,
                                                                                            pendingordermodal?.data?[index].orderNumber == '' || pendingordermodal?.data?[index].orderNumber == null ? 'N/A' : pendingordermodal?.data?[index].orderNumber ?? '',
                                                                                            style: TextStyle(overflow: TextOverflow.ellipsis, color: Colors.black, fontSize: 10.sp, fontWeight: FontWeight.w600, fontFamily: "task"),
                                                                                          ),
                                                                                        ],
                                                                                      ),
                                                                ...
                                                                onTap: () {
                                                                  Navigator.of(
                                                                      ...
                                                                      .push(MaterialPageRoute(
                                                                          builder: (context) =>
                                                                              OrderSummary(iteamid: deliveredordermodal?.data?[index].orderId)));
                                                                },
                                                                child: Card(
                                                                  child:
                                                                      Container(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: CachedNetworkImage(
                                                                                  imageUrl: deliveredordermodal?.data?[index].firstImage ?? '',
                                                                                  height: 25.w,
                                                                                  width: 25.w,
                                                                                  imageBuilder: (context, imageProvider) => Container(
                                                                                    decoration: BoxDecoration(
                                                                                        ...
                                                                                        child: SizedBox(
                                                                                          ...
                                                                                          child: Row(
                                                                                            children: [
                                                                                              ...
                                                                                              Text(
                                                                                                maxLines: 1,
                                                                                                deliveredordermodal?.data?[index].orderNumber == '' || deliveredordermodal?.data?[index].orderNumber == null ? 'N/A' : deliveredordermodal?.data?[index].orderNumber ?? '',
                                                                                                style: TextStyle(overflow: TextOverflow.ellipsis, color: Colors.black, fontSize: 10.sp, fontWeight: FontWeight.w600, fontFamily: "task"),
                                                                                              ),
                                                                                            ],
                                                                                          ),
                                                              ...
                                                              return GestureDetector(
                                                                onTap: () {
                                                                  Navigator.of(
                                                                      ...
                                                                      .push(MaterialPageRoute(
                                                                          builder: (context) =>
                                                                              OrderSummary(iteamid: ordercancelmodal?.data?[index].orderId)));
                                                                },
                                                                child: Card(
                                                                  child:
                                                                      Container(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              child: Padding(
                                                                                padding: EdgeInsets.all(3.0),
                                                                                child: CachedNetworkImage(
                                                                                  imageUrl: ordercancelmodal?.data?[index].firstImage ?? '',
                                                                                  height: 25.w,
                                                                                  width: 25.w,
                                                                                  imageBuilder: (context, imageProvider) => Container(
                                                                                    decoration: BoxDecoration(
                                                                                    ...
                                                                                    children: [
                                                                                        ...
                                                                                        child: SizedBox(
                                                                                          ...
                                                                                          child: Row(
                                                                                            children: [
                                                                                              ...
                                                                                              Text(
                                                                                                maxLines: 1,
                                                                                                ordercancelmodal?.data?[index].orderNumber == '' || ordercancelmodal?.data?[index].orderNumber == null ? 'N/A' : ordercancelmodal?.data?[index].orderNumber ?? '',
                                                                                                style: TextStyle(overflow: TextOverflow.ellipsis, color: Colors.black, fontSize: 10.sp, fontWeight: FontWeight.w600, fontFamily: "task"),
                                                                                              ),
                                                                                            ],
                                                                                          ),
                                                                                      ...
                                                                                      Row(
                                                                                        children: [
                                                                                          Text(
                                                                                            "cancelled",
                                                                                            style: TextStyle(fontSize: 11.sp, fontFamily: 'task', fontWeight: FontWeight.bold, letterSpacing: 1, color: Colors.red),
                                                                                          ),
                                                                                          SizedBox(
                                                                                            width: 4.w,
                                                                                          ),
    ...
    checkInternet().then((internet) async {
      if (internet) {
        authprovider().orderpaidapi(data).then((response) async {
          paidorderModel = PaidOrderModel.fromJson(json.decode(response.body));
