              ...
              : Column(
                  ...
                  children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(left: 12.w),
                        child: Text(
                          "An order for medicines or healthcare"
                      ...
                      Padding(
                        padding: EdgeInsets.only(left: 12.w),
                        child: Text(
                          "We have product specific return policy. "
                      ...
                      Padding(
                        padding: EdgeInsets.only(left: 12.w),
                        child: Text(
                          "All healthcare products have specific"
                          ...
                          " Please check the return policy before placing any order.",
                          style: TextStyle(
                            fontSize: 12.sp,
                            fontFamily: "task",
                          ),
                      ...
                      Padding(
                        padding: EdgeInsets.only(left: 12.w),
                        child: Text(
                          "1.1 Please note that the refund amount"
                          ...
                          " you will be initiated for eligible returns as mentioned above.",
                          style: TextStyle(
                            fontSize: 12.sp,
                            fontFamily: "task",
                          ),
