...
final GlobalKey<ScaffoldState> _scaffoldKeylist31 = GlobalKey<ScaffoldState>();
...
class _ProductList3State extends State<ProductList3> {
                                  ...
                                  ? SliverGrid(
                                      ...
                                      delegate: SliverChildBuilderDelegate(
                                        ...
                                        childCount: (shortbymodel
                                                    ?.searchResults?.length ??
                                                0) +
                                            1, // Adding 1 to show loader at the end
                                        // childCount: shortbymodel
                                        //     ?.searchResults?.length,
                                      ),
                                    )
                                  : type
                                      ...
                                      : _serch2.text == ''
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          child:
                                                                              CachedNetworkImage(
                                                                            imageUrl:
                                                                                bestsellerproductmodal?.productData?[index].imgData ?? '',
                                                                            height:
                                                                                9.5.h,
                                                                            width:
                                                                                25.w,
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap: () {
                                                                      usermodal?.userId == "" ||
                                                                          ...
                                                                          : bestsellerproductmodal?.productData?[index].wishlist == 1
                                                                              ? removewishlistap((bestsellerproductmodal?.productData?[index].productID).toString())
                                                                              : addwishlistap((bestsellerproductmodal?.productData?[index].productID).toString());
                                                                    },
                                                                    child: Icon(
                                                                      bestsellerproductmodal?.productData?[index].wishlist == 1
                                                                          ? Icons
                                          ...
                                          : _issearch
                                              ...
                                              : searchbestsaleModal?.productData
                                                              ?.length ==
                                                          0 ||
                                                      searchbestsaleModal
                                                              ?.productData
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          child:
                                                                              CachedNetworkImage(
                                                                            imageUrl:
                                                                                searchbestsaleModal?.productData?[index].imgData ?? '',
                                                                            fit:
                                                                                BoxFit.cover,
                                                                            height:
                                                                                9.5.h,
                                                                                ...
                                                                                children: [
                                                                                  SizedBox(
                                                                                    ...
                                                                                    child: Text(
                                                                                      ...
                                                                                      overflow: TextOverflow.ellipsis,
                                                                                      maxLines: 1,
                                                                                      searchbestsaleModal?.productData?[index].productName ?? '',
                                                                                      style: TextStyle(fontSize: 11.sp, fontFamily: 'task', fontWeight: FontWeight.bold, letterSpacing: 1, color: Colors.black),
                                                                                    ),
                                                                                  ),
                                                                                ],
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap: () {
                                                                      usermodal?.userId == "" ||
                                                                          ...
                                                                          ? Navigator.of(context)
                                                                              .push(MaterialPageRoute(builder: (context) => LoginPage2()))
                                                                          : searchbestsaleModal?.productData?[index].wishlist == 1
                                                                              ? removewishlistap((searchbestsaleModal?.productData?[index].productID).toString())
                                                                              : addwishlistap((searchbestsaleModal?.productData?[index].productID).toString());
                                                                    },
                                                                    child: Icon(
                                                                      searchbestsaleModal?.productData?[index].wishlist == 1
                                                                          ? Icons
                                                                      ...
                                                                      size:
                                                                          20.sp,
                                                                      color: searchbestsaleModal?.productData?[index].wishlist == 1
                                                                          ? Colors
                                                                              .red
                                                                          : Colors
                                                                              .black,
  ...
  Timer? _debounce; // Declare a debounce timer
        ...
        onChanged: (value) {
          ...
          _debounce = Timer(Duration(seconds: 2), () {
            if (_serch2.text.isNotEmpty) {
              bestsalesserchap(_serch2.text); // Call the API with current text
            }
          });
        },
        style:
          ...
          suffixIcon: _serch2.text.isNotEmpty
              ? IconButton(
                  ...
                  onPressed: () {
                    ...
                    setState(() {
                      _serch2.clear(); // Clear the search field
                      _issearch = false;
                      sort = false;
                      type = false;
                    });
                    Timer(Duration(seconds: 2), () {
                      bestsalesserchap(''); // Refresh or reset search
                    });
                  },
                )
              : null,
