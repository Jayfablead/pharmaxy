class AllSubcatWiceProduct {
  String? status;
  List<SubcategoriesWiseProduct>? subcategoriesWiseProduct;

  AllSubcatWiceProduct({this.status, this.subcategoriesWiseProduct});

  AllSubcatWiceProduct.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['subcategories_wise_product'] != null) {
      subcategoriesWiseProduct = <SubcategoriesWiseProduct>[];
      json['subcategories_wise_product'].forEach((v) {
        subcategoriesWiseProduct!.add(new SubcategoriesWiseProduct.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.subcategoriesWiseProduct != null) {
      data['subcategories_wise_product'] =
          this.subcategoriesWiseProduct!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class SubcategoriesWiseProduct {
  String? productID;
  String? productSKU;
  String? productType;
  String? categoryID;
  ...
  SubcategoriesWiseProduct.fromJson(Map<String, dynamic> json) {
