...
//
//   SubCatSerchModal({this.status, this.categoriesWiseProduct});
//
...
class CatSerchModal {
  ...
  CatSerchModal({this.status, this.categoriesWiseProduct});

  CatSerchModal.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['categories_wise_product'] != null) {
      categoriesWiseProduct = <CategoriesWiseProduct>[];
      json['categories_wise_product'].forEach((v) {
